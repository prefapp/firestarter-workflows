...
VALID_CONFIG_FILE_PATH: str =\
    os.path.join(os.path.dirname(__file__), 'fixtures/flavor.yml')

INVALID_CONFIG_FILE_PATH: str =\
    os.path.join(os.path.dirname(__file__), 'fixtures/flavor_error.yml')

SCHEMA_FILE_PATH: str = '../workflows/build_images/resources/flavor_schema.json'
